    ...
    <div class="z-input" :class="{
        ...
        <template v-if="type !== 'textarea'">
            ...
            <div class="z-input__wrapper">
                ...
                <input class="z-input__inner" :type="showPassword ? (passwordVisible ? 'text' : 'password') : type"
                ...
                <!-- suffix slot -->
                <span v-if="$slots.suffix || showClear || showPasswordArea" class="z-input__suffix" @click="keepFocus">
                    <slot name="suffix" />
                    <Icon icon="circle-xmark" v-if="showClear" class="z-input__clear" @click="clear"
                        @mousedown.prevent="NOOP" />
                    <Icon icon="eye" v-if="showPasswordArea && passwordVisible" class="z-input__password"
                        @click="togglePasswordVisible" />
                    <Icon icon="eye-slash" v-if="showPasswordArea && !passwordVisible" class="z-input__password"
                        @click="togglePasswordVisible" />
                </span>
            </div>
            <!-- append slot -->
        ...
        <!-- textarea -->
        <template v-else>
            <textarea class="z-textarea__wrapper" v-bind="attrs" ref="inputRef" :disabled="disabled"
